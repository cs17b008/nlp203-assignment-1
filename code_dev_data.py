...
# Parse the XML file
tree = ET.parse('/Users/vijaychilaka/Downloads/fr-en/IWSLT13.TED.dev2010.fr-en.en.xml')
tree1 = ET.parse('/Users/vijaychilaka/Downloads/fr-en/IWSLT13.TED.dev2010.fr-en.fr.xml')
root = tree.getroot()
root1 = tree1.getroot()

english_text_arrays_dev = []
french_text_arrays_dev = []
    ...
    for subchild in child:
        ...
        for subchild_1 in subchild:
            if subchild_1.tag == 'seg':
                english_text_arrays_dev.append(subchild_1.text)
    ...
    for subchild_f in child_f:
        ...
        for subchild_1_f in subchild_f:
            if subchild_1_f.tag == 'seg':
                french_text_arrays_dev.append(subchild_1_f.text)
